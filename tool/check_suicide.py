...
def check_one_contract_on_suicide(
        contract_bytecode,
        contract_address,
        debug,
        read_from_blockchain,
    ...
    # Make the amount of sent Ether symbolic variable (i.e., it can take any
    # value)
    ...
    if MyGlobals.stop_search:
        ...
        print(
            '\n\n\033[91m[-] Suicidal vulnerability found! \033[0m\n\n    The following %d transaction(s) will trigger the contract to be killed:' %
        ...
        if confirm_exploit:
            ...
            print(
                '\033[1m[ ] Confirming suicide vulnerability on private chain ... \033[0m',
                end='')
            ...
            if len(bcod) <= 2:
                ...
                print(
                    '\033[94m    Cannot confirm the suicide vulnerability \033[0m')
